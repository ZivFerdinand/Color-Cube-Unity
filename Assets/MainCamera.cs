...
public class MainCamera : MonoBehaviour
{
    ...
    Camera mainLight; // Variable for storing data type of Light (component) 
    ...
    private void Awake()
    {
        if(changeColor)
        {
            mainLight = GetComponent<Camera>(); // Reference to the game object's Light component 
            red = 255;
            mainLight.backgroundColor = new Color32(red, green, blue, alpha); // Default color of Light set to RGB(255, 0, 0) 
    ...
    private void AnimateLightingInRainbow() // Function for changing the color of Light 
    {
        ...
        mainLight.backgroundColor = new Color32(red, green, blue, alpha); // Update the RGB value of the color of Light with the RGB value calculated from the above if-else statements
